...
// let
function iniciarTime1(iniciaJogo1: boolean) {
    var nome1 = 'Messi e amigos';
    let cidade1 = 'em São Paulo';
...
// const
function iniciarTime2(iniciaJogo2: boolean) {
    const nome2 = 'Messi e amigos';
    let cidade2 = 'em Brasília';
